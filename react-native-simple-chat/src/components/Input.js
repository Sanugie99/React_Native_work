        ...
        return (
            <Container>
                ...
                <StyledTextInput
                    ...
                    onBlur={() => { //TextInput에 포커스가 해제될 때 호출되는 함수
                        setIsFocused(false);
                        onBlur();
                    }}
                    placeholder={placeholder} //아무것도 입력하지 않았을 때 힌트 텍스트
                    secureTextEntry={isPassword} //true로 설정하면 글자가 oooo으로 나온다
                    returnKeyType={returnKeyType} //키보드에서 Return의 모양을 결정한다.
                    maxLength={maxLength} //사용자가 입력할 수 있는 최대 글자 수
                    autoCapitalize="none" //자동 대문자 변환 끔
                    autoCorrect={false} //자동 맞춤법 수정기능 끔
                    textContentType="none" // iOS전용 속성, 입력데이터에 자동완성, 자동 채움 같은 제안을 컨트롤 할 수 있다.
